"""
Django settings for triplodocus project.
...
WSGI_APPLICATION = 'triplodocus.wsgi.application'
...
AWS_ACCESS_KEY_ID = 'AKIA2GMBHWDCWOKKX6G2'
AWS_SECRET_ACCESS_KEY = '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'
